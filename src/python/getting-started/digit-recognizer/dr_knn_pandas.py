...
def opencsv():
    # 使用 pandas 打开
    data = pd.read_csv('/Users/caishuo.cs/Downloads/digit-recognizer/train.csv')
    data1 = pd.read_csv('/Users/caishuo.cs/Downloads/digit-recognizer/test.csv')
...
def dRecognition_knn():
    ...
    saveResult(
        testLabel,
        '/Users/caishuo.cs/Downloads/digit-recognizer/output/Result_sklearn_knn.csv'
    )
    print("finish!")
